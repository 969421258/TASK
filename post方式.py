...
>>> import urllib
>>> import urllib2
>>> values = {"username":"3301257530@qq.com","password":"love74520&@qq.co"}
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=F4B0EC4B83D0373282B48613E5D940D3.tomcat2" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=F4B0EC4B83D0373282B48613E5D940D3.tomcat2" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=F4B0EC4B83D0373282B48613E5D940D3.tomcat2" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=F4B0EC4B83D0373282B48613E5D940D3.tomcat2?from=http://my.csdn.net/my/mycsdn" method="post">
					...
					<input type="hidden" name="lt" value="LT-575437-NyRcvL4fSASXcltkUqV6eBBblGvgQ2" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=F4B0EC4B83D0373282B48613E5D940D3.tomcat2"></script>
    ...
    <script data-main="/js/login-config.js;jsessionid=F4B0EC4B83D0373282B48613E5D940D3.tomcat2" src="/js/libs/require.js;jsessionid=F4B0EC4B83D0373282B48613E5D940D3.tomcat2"></script>
    <script type="text/javascript">
